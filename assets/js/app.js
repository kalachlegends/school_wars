...
$(document).ready(function () {
  ...
  $(".drop-down").click(function (event) {
    ...
    if (originalEvent.path[1].className == "drop-down__item")
      text = originalEvent.path[1].textContent;
    if (originalEvent.path[2].className == "drop-down__item")
      text = originalEvent.path[2].textContent;

    if (
      originalEvent.path[1].className == "drop-down__item" ||
...
x = document.getElementsByClassName("select-class");
l = x.length;
for (i = 0; i < l; i++) {
